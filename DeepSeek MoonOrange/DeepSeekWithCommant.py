...
class DeepSeekChat:
    def __init__(self, root):
        # 初始化主窗口
        self.root = root
        self.root.title("DeepSeek For MoonOrange v1.1")
        iconDeepSeek = ImageTk.PhotoImage(Image.open(self.resource_path("deepseek.png")))
        root.iconphoto(False, iconDeepSeek)# 设置窗口图标
        ...
        self.api_info = tk.StringVar(value="API余额: 未知") # DeepSeek API状态
